  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <div className={`family-form-container ${containerClassName}`}>
          {showTitle && title && (
            <h2 className="text-2xl font-bold mb-4 text-center">{title}</h2>
          )}
          
          <div className={`family-form-wrapper ${className}`} style={{ minHeight: height }}>
            <iframe
              ref={iframeRef}
              src="https://form.jotform.com/252154439493866"
              width={width}
              height={height}
              frameBorder="0"
              scrolling="auto"
